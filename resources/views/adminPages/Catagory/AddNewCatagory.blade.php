    ...
    <div class="section bg-light" style="height:auto">
        ...
        <div class="col-sm-9 mt-2 container-fluid border border-end-0 ms-2   ">
                ...
                @if ($errors->any())
                    ...
                    @endif
                    <form action="{{url('adminPages/Catagory')}}" class="was-validated row" method="POST">
                    @csrf
                        ...
                        <div class=" col mt-3 mb-3">
                            ...
                            <input type="text" class="form-control is-valid" id="validationServer01" placeholder="catagory Description" name="catagory_description" required>
                            @error('catagory_description')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                        ...
                        <div class="conatiner mx-auto d-grid col-6">
                            <button type="submit"  class="btn btn-primary mb-3 ">Add New Catagory</button>
