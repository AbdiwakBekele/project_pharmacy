...
<body>
  ...
  <div class="container col border  ps-4 rounded mt-4 ">
                ...
                <div class=" h3 pt-1 h3-lead">
                    <i class="bi bi-house-fill"></i> Unit Types
                </div>
                <hr>
            ...
            <div class="row shadow-lg  rounded border mt-5 ">
                        ...
                        <div class="col-5 ps-4 pt-2">
                            ...
                            <a href="{{url('adminPages/Unit/AddNewUnit')}}" class="btn btn-outline-secondary " role="button" >+ Add New Unit</a>
                        </div>
                        <div class=" col-7 p-2 ">
                  ...
                  <table class="table table-striped table-bordered">
                      <thead class="text-white bg-info text-center">
                          <tr>
                              ...
                              <th scope="col-1">unit_ID</th>
                              <th scope="col-1">Unit Name</th>
                              <th scope="col-1">Unit Description</th>
                      ...
                      @foreach ($units as $unit)
                          <tr>
                              ...
                              <td>
                              <a href="{{url('adminPages/Unit/'.$unit->id.'/delete')}}" class="btn btn-danger">Delete</a>
                              </td>
                          </tr>
