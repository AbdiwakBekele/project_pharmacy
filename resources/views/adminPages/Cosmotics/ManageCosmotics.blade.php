...
<div class="container mt-4">
                ...
                <div class="container col border  ps-4 rounded mt-4 ">
                    ...
                    <div class=" h3 pt-1 h3-lead">
                        <i class="bi bi-house-fill"></i> Cosmotic Types
                    </div>
                    <hr>
                ...
                <div class="row shadow-lg  rounded border mt-5 ">
                        ...
                        <div class="col-5 ps-4 pt-2">
                            ...
                            <a href="{{url('adminPages/Cosmotic/AddNewCosmotic')}}" class="btn btn-outline-secondary " role="button" >+ Add New Cosmotics</a>
                        </div>
                        <div class=" col-7 p-2 ">
                  ...
                  <table class="table table-striped table-bordered">
                        <thead class="text-white bg-info text-center">
                            <tr>
                                ...
                                <th scope="col-1">Cosmotics Name</th>
                        ...
                        @foreach($cosmotics as $cosmotic)
                            <tr>
                                ...
                                <td>{{ ++$i }}</td>
                                <td>{{ $cosmotic->id }}</td>
                                <td>{{ $cosmotic->cosmotic_name }}</td>
                                <td>{{ $cosmotic->cosmotic_exp }}</td>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('adminPages/Cosmotic/'.$cosmotic->id.'/delete')}}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                            @endforeach 
                        </tbody>
