...
<body>
  ...
  <div class="background1 container-fluid" id="mainbody">
        <div class="container col-6 p-5 text-center" >
                        <div class="row">
                ...
                <div class="container text-white ps-4  mt-4 w-75">
                ...
                <div class="container  border mt-5 w-50 ">
                    <div class="d-grid gap-4 pt-4 ps-3 pb-4 ">
                        ...
                        <form class="row g-3" method="POST" action="{{url('SalesPages/ManageSaless')}}">
                        
                        @csrf
                            <div class="row">
                                <div class="col-md-8">
                    
                                    <label for="validationCustom01" class="form-label"><i class="bi bi-file-earmark-text-fill"></i> Cosmotics</label>
                                        <div class="container border p-2 rounded">
                       
                                            <select name="cosmoticSalesName" class="form-select" id="validationCustom04" required>
                           
                                                 <option selected disabled value="">Choose...</option>
                                                    @foreach($cosmotics as $cosmotic)
                                                        <option value="{{ $cosmotic->id}}">
                                                            {{ $cosmotic->cosmotic_name }}
                                                        </option>
                                                    @endforeach
