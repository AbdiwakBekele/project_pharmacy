...
if(isset($_POST["submit"])){ 
    ...
    $sql= "INSERT INTO unit (unit_id, unit_name, unit_description) VALUES (NULL, '$unit_name', '$unit_description')";
    ...
    <?php include "db_con.php"; ?>
        ...
        <div class="col-sm-9 mt-2 container-fluid border border-end-0 ms-2   ">
                ...
                <div class="container border mt-4 ">
                    <form action="AddUnitType.php" class="was-validated row" method="POST">
