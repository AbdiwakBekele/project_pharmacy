...
$all_drug=mysqli_query($conn,$sql);
...
if(isset($_POST['submit']))
{
    ...
    $drugType_id =$_POST['drugType'];
    // $unit_id =$_POST['unit'];

    
   
    $sql_insert =
    "INSERT INTO drugType(drug_id,drugType_id,batchNumber,manufactureDate,ExpireDate, amount)
        VALUES (NULL,'$drugType_id','$batchNumber','$manufactureDate','$ExpireDate','$amount')";
      
    
   
    if(mysqli_query($conn,$sql_insert)){
        header('Location: ManageDrug.php?msg=new recored created succesfully');
    }
    else{
    ...
    <?php include "db_con.php"; ?>
        ...
        <div class="col-sm-9 mt-2 container-fluid border border-end-0 ms-2   ">
            ...
            <div class="container border rounded ">
                    <form class="row g-3" method="POST" action="AddDrug.php">
                      <div class="col-md-6">
                         ...
                         <label for="validationCustom01" class="form-label"><i class="bi bi-file-earmark-text-fill"></i> Drug Type</label>
                            ...
                            <select name="drugType" class="form-select" id="validationCustom04" required>
                                ...
                                <option selected disabled value="">Choose...</option>
                                    <?php
                                     while ($drugType = mysqli_fetch_array(
                                        $all_drug,MYSQLI_ASSOC)):;
                                        
                                    ?>
                                    <option value="<?php echo $drugType["drugType_id"];
                                         // The value we usually set is the primary key
                                                 ?>">
                                          <?php echo $drugType["brand"];
                                   
                                        ?> (<?php echo $drugType["generic"]?>)<?php echo $drugType["dosage"]?>
                                    </option>
                               <?php
                                      endwhile;
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control is-invalid" id="validationServer03" placeholder="Batch Number" name="batchNumber" aria-describedby="validationServer03Feedback" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control is-invalid" id="validationServer03" placeholder="mm/dd/yyyy" name="manufactureDate" aria-describedby="validationServer03Feedback" required>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                fill-out
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control is-invalid" id="validationServer05" placeholder="mm/dd/yyyy" name="ExpireDate" aria-describedby="validationServer05Feedback" required>
