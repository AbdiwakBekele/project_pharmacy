...
<div class="container mt-4">
      ...
      <div class="container col border  ps-4 rounded mt-4 ">
                    ...
                    <div class=" h3 pt-1 h3-lead">
                        <i class="bi bi-house-fill"></i> Drug Types
                    </div>
                    <hr>
                ...
                <div class="row shadow-lg  rounded border mt-5 ">
                        ...
                        <div class="col-5 ps-4 pt-2">
                            ...
                            <a href="AddNewDrugType.php" class="btn btn-outline-secondary " role="button" >+ Add New Drug Type</a>
                        </div>
                        <div class=" col-7 p-2 ">
...
<thead class="text-white bg-info text-center">
    <tr>
        ...
        <th scope="col-1">Drug Type ID</th>
        <th scope="col-1">Catagory Name</th>
        <th scope="col-1">Unit Name</th>
        <th scope="col-1">Drug Type Name</th>
        <th scope="col-1">Dosage</th>
...
<?php
    ...
    $sql2="SELECT drugTypetable.drugType_id, catagory.catagory_name, unit.unit_name,drugTypetable.brand,drugTypetable.generic,drugTypetable.dosage,drugTypetable.price
    FROM ((drugTypetable
    INNER JOIN catagory ON drugTypetable.catagory_id = catagory.catagory_id)
    INNER JOIN unit ON drugTypetable.unit_id = unit.unit_id);";
    ...
    <tr>
        ...
        <td><?php echo $row["drugType_id"]?></td>
        <td> <?php echo $row["catagory_name"]?></td>
        <td><?php echo $row["unit_name"]?></td>
        
        <td><?php echo $row["brand"]?> (<?php echo $row["generic"]?>)</td>
...
<a href="delete.php?id=<?php echo $row["drugType_id"]?>" class="btn">
