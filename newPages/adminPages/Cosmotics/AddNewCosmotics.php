...
if(isset($_POST["submit"])){ 
    ...
    $cosmotic_name=$_POST['cosmotic_name'];
    $expire_date=$_POST['expire_date'];
    $total_amount=$_POST['total_amount'];
    $price=$_POST['price'];

    $sql= "INSERT INTO cosmotics (cosmotic_id, cosmotic_name,expire_date,total_amount,price) VALUES (NULL, '$cosmotic_name', '$expire_date','$total_amount','$price')";


    $result=mysqli_query($conn,$sql);

    if($result){
        header('Location: ManageCosmotic.php?');
    }
    else{
    ...
    <?php include "db_con.php"; ?>
        ...
        <div class="col-sm-9 mt-2 container-fluid border border-end-0 ms-2   ">
                ...
                <div class="container border rounded ">
                    <form class="row g-3"  action="AddNewCosmotics.php" method="POST">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control is-invalid" id="validationServer03" placeholder="mm/dd/yyyy" name="expire_date" aria-describedby="validationServer03Feedback" required>
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                fill-out
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control is-invalid" id="validationServer05" placeholder="Total amount" name="total_amount" aria-describedby="validationServer05Feedback" required>
