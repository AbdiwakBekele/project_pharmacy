...
<div class="container mt-4">
                ...
                <div class="row shadow-lg  rounded border mt-5 ">
                        ...
                        <div class="col-5 ps-4 pt-2">
                            ...
                            <a href="AddNewCosmotics.php" class="btn btn-outline-secondary " role="button" >+ Add New Cosmotics</a>
                        </div>
                        <div class=" col-7 p-2 ">
                  ...
                  <table class="table table-striped table-bordered">
                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo $row["cosmotic_id"]?></td>
                                <td><?php echo $row["cosmotic_name"]?></td>
                                ...
                                <td>
                                    ...
                                    <a href="delete.php?id=<?php echo $row["cosmotic_id"]?>" class="btn">
