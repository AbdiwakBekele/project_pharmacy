<?php      
    ...
    $password = $_POST['pswd'];  
        ...
        $sql = "select *from Login where email = '$email' and password = '$password' and user_type='admin'" ;  
            ...
            <div class="row">
                <div class="col-4">
                    <div class="container ps-2 ms-0">
                        ...
                        <div class="overlay">
                            <div class="text">hello i am admin</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 border  pt-5">
                    <form action="AdminLogin.php" method="POST">
                        ...
                        <a href=""><button type="submit" name="submit" class="btn btn-primary col-5 ms-5">Login</button></a>
