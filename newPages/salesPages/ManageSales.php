  ...
  <div class="container w-50 text-center p-5">
     ...
     <div class="container  border rounded  border-3 mt-5 w-50 ">
         <div class="d-grid gap-4 pt-4 ps-3 pb-4 ">
            ...
            <a href="DrugSales.php"><button class="btn btn-primary col-6" type="button">Drug Sales</button></a>

            <a href="CosmoticSales.php"><button class="btn btn-primary col-6" type="button">Cosmotics Sales</button></a>
